...
export default function Vendors() {
  ...
  const vendors = [
    ...
    { title: "Manga Tent", category: "Books", day: "Saturday", link: "/mangaTent", bgColor: "bg-orange-100" },
    { title: "Conbini", category: "Snacks", day: "Sunday", link: "/conbini", bgColor: "bg-red-200" },
