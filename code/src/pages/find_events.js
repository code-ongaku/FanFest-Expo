  ...
  const events = [
    {
      ...
      day: "Friday",
      link: "/individual_event/opening_ceremony",
      bgColor: "bg-red-200",
    },
    {
      title: "Arcade",
      time: "Friday: 10 am - 4 pm",
      category: "Gaming",
      day: "Friday",
      link: "/individual_event/arcade",
      bgColor: "bg-blue-200",
    },
    {
      title: "FanFest Expo",
    ...
    {
      title: "Contest A: Cosplay",
      time: "Friday: 11 am - 12 pm",
      category: "Contests",
      day: "Saturday",
      link: "/contest-A-cosplay",
    ...
    },
    {
      ...
      category: "Concerts",
      day: "Saturday",
      link: "/individual_event/idol_fest",
      bgColor: "bg-purple-200",
    },
    {
      title: "Contest B: Card Collections",
      time: "Friday: 12 pm - 1 pm",
      category: "Contests",
      day: "Sunday",
      link: "/contest-B-card-collections",
      bgColor: "bg-green-200",
    },
    {
      title: "Concert: Pop Rock",
      time: "Friday: 12 pm - 3 pm",
      category: "Concerts",
      day: "Sunday",
      link: "/concert-pop-rock",
      bgColor: "bg-purple-200",
    },
    {
      title: "Contest C: Movie Props",
      time: "Friday: 1 pm - 2 pm",
      category: "Contests",
      day: "Friday",
      link: "/contest-c-movie-props",
      bgColor: "bg-green-200",
    },
  ];
        ...
        <div className="mt-6 max-h-[350px] overflow-y-auto">
          {filteredEvents.map((event, index) => (
            <Link key={index} href={event.link} passHref>
              <div
                className={`${event.bgColor} p-4 rounded-lg mb-2 cursor-pointer flex justify-between items-center`}
              >
                <div>
