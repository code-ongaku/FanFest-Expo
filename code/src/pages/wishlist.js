...
export default function Wishlist() {
    ...
    const Bookmarks = [
        ...
        { title: "Make Your Own Cosplay", num: 3, time: "Friday: 12 pm - 2 pm", day: "Friday", link: "/makeYourOwnCosplay", bgColor: "bg-red-200" },
        { title: "Balancing Work and Expo", num: 4, time: "Sunday: 10 am - 12 pm", day: "Sunday", link: "/balancingWorkAndExpo", bgColor: "bg-red-200" },
